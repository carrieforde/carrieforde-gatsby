...
<CallOut type="tip">
  If you use VS Code and type the code into your spec, VS Code will pull the
  required import statement(s) into your file.
</CallOut>
...
<cf-alert type="info">
  If you're using VS Code, now is a good time to add the{" "}
  <a href="https://marketplace.visualstudio.com/items?itemName=alexkrechik.cucumberautocomplete">
    Cucumber (Gherkin) Full Support
  </a>{" "}
  extension. This extension helps stub out tests more quickly with code hinting.
</cf-alert>
