...
<CallOut
  type="INFO"
  text="Skipping the <code>MergeField</code> component tests only reduced coverage of the component by about 10 percent on the final project."
/>
...
<CallOut
  type="TIP"
  text="The above assertion is the only one needed for the <code>MergeField</code> to get 100 percent test coverage. The utility tests cover the rest."
/>
